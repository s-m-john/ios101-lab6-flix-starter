...
//  ios101-lab6-flix
//
//  Created by Sophia John on 10/21/23.
//
...
class DetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        guard let movie = movie else {
            // Handle the case where 'movie' is nil, such as showing an error message or taking some other appropriate action.
            return // Exit early from the function or scope
        }
